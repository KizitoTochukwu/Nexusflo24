...
export const TRIGGER_OPTIONS = [
  ...
  { value: "instagram_comment", label: "Instagram comment with keyword" },
  { value: "instagram_dm", label: "Instagram DM with keyword" },
  { value: "facebook_comment", label: "Facebook comment with keyword" },
  { value: "facebook_dm", label: "Facebook Messenger DM with keyword" },
...
export const ACTION_OPTIONS = [
  ...
  { value: "update_pipeline_stage", label: "Update Pipeline Stage", icon: "GitBranch" },
