import { CONTACT_VARIABLES, LEAD_VARIABLES, DEAL_VARIABLES, ASSIGNED_USER_VARIABLES, AUTOMATION_LINKS } from "./editorConstants";

const ALL_VARIABLES = [...CONTACT_VARIABLES, ...LEAD_VARIABLES, ...DEAL_VARIABLES, ...ASSIGNED_USER_VARIABLES, ...AUTOMATION_LINKS];
