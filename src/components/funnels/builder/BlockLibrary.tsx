import {
  ...
  DollarSign, HelpCircle, Code, Video, CalendarDays, LayoutGrid, Timer,
} from "lucide-react";
...
const GROUPS = [
  ...
  { label: "Conversion", types: ["form", "countdown", "testimonials", "pricing", "faq", "cards", "booking"] as BlockType[] },
