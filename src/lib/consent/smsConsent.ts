...
export const SMS_CONSENT_TEXT =
  "I agree to receive SMS messages from NexusFlo24 about my enquiry, demo booking, account updates, appointment reminders, and service notifications. Message frequency varies. Message and data rates may apply. Reply STOP to opt out or HELP for help. Consent is not a condition of purchase. View our Privacy Policy and Terms.";
